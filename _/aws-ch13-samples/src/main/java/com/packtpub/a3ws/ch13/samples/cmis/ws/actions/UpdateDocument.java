...
public class UpdateDocument {
	...
	private static Log log = LogFactory.getLog(UpdateDocument.class);
	...
	public static void main(String[] args) throws CmisException {
		...
		DataHandler dataHandlerUpdate = new DataHandler(contentUpdate, "text/plain");
		...
		objectService.setContentStream(repositoryId, idHolder, true, changeToken, streamUpdate, null);
