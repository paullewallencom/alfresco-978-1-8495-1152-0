...
public class CancelCheckout {
	...
	public static void main(String[] args) throws RepositoryFault, RemoteException {
		...
		try {
	        ...
	        //Cancel Checkout
	        CancelCheckoutResult cancelCheckOutResult = authoringService.cancelCheckout(workingCopy);
	        System.out.println("CancelCheckOutResult: "+ cancelCheckOutResult.getOriginals()[0].getPath());
