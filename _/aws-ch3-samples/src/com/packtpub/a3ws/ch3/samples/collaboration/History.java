...
public class History {
	...
	public static void main(String[] args) throws RepositoryFault, RemoteException {
		...
		try {
	        ...
	        Predicate predicateForVersion = new Predicate(new Reference[]{checkedInNode}, spacesStore, null);
	        ...
	        VersionHistory versionHistory = authoringService.getVersionHistory(checkedInNode);
