...
public class SetOwners {
	...
	public static void main(String[] args) throws AccessControlFault, RemoteException {
		...
		try {
			...
			OwnerResult[] ownerResults = accessControlService.setOwners(predicate, "admin");
			for (OwnerResult ownerResult : ownerResults) {
				System.out.println("Owner: "+ ownerResult.getOwner() + "| node:" + ownerResult.getReference().getPath());
			}
