...
public class MoveNode {
	...
	public static void main(String[] args) throws RepositoryFault, RemoteException {
		...
		String name = "AWS Book - Content Moved "+System.currentTimeMillis();
		String spaceNameForMove = "AWS Book - Move Space Sample "+System.currentTimeMillis();
		...
		try {
	        ...
	        System.out.println("Node: "+referenceForNode.getPath()+" moved to space: "+targetSpace.getPath());
