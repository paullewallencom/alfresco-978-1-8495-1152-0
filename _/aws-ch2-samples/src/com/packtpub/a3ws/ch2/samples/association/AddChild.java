...
public class AddChild {
	...
	public static void main(String[] args) throws RepositoryFault, RemoteException {
		...
		String name = "AWS Book - Content Add Child "+System.currentTimeMillis();
		String spaceNameForMove = "AWS Book - Add Child Space Sample "+System.currentTimeMillis();
		...
		try {
			...
			NamedValue[] propertiesForSpace = buildCustomProperties(name,name,description);
