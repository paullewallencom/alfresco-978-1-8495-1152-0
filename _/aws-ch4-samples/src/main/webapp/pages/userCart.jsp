...
<body bgcolor="white">
	...
	<logic:notEmpty name="cart">
		<logic:iterate id="book" name="cart">
			<p><bean:write name="book" property="title"/> | <a title="Remove this book from your cart" href="/aws-ch4-samples/confirmRemoveFromCart.do?id=<bean:write name="book" property="id"/>"><strong>remove</strong></a></p>
		</logic:iterate>
	</logic:notEmpty>
	<logic:empty name="cart">
